...
#define CONFCMDLINE "--with-pythonmodule --with-pyunbound PYTHON_VERSION=3.11 PYTHON_LDFLAGS=-L/usr/lib/python3.11/config-3.11-aarch64-linux-gnu -L/usr/lib/aarch64-linux-gnu -lpython3.11 -ldl -lm PYTHON_CPPFLAGS=-I/usr/include/python3.11 -I/usr/include/python3.11"
